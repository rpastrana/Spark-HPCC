...
public class HpccRelation extends BaseRelation implements PrunedFilteredScan
{
    ...
    {
//        FileFilter andedFilters = null;
//        try
//        {
//            andedFilters = FileFilterConverter.CovertToHPCCFileFilter(filters);
//        }
//        catch (Exception e)
//        {
//            log.error("Error validating filters: " + e.getLocalizedMessage());
//        }
//
//        if (andedFilters == null || andedFilters.isEmpty())
//            return filters;
//        else
//            return new Filter [0];
